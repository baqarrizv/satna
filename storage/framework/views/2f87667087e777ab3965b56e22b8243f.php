...
<script src="<?php echo e(URL::asset('/assets/js/select2-init.js')); ?>"></script>
...
<?php if(config('settings.enable_push_notifications') && !empty(config('settings.onesignal_app_id')) && !empty(config('settings.onesignal_api_key'))): ?>
<script src="https://cdn.onesignal.com/sdks/web/v16/OneSignalSDK.page.js" defer></script>
<script>
  window.OneSignalDeferred = window.OneSignalDeferred || [];
  OneSignalDeferred.push(async function(OneSignal) {
    await OneSignal.init({
      appId: "<?php echo e(config('settings.onesignal_app_id')); ?>",
    });
    
    <?php if(Auth::check()): ?>
        await OneSignal.login("<?php echo e(Auth::user()->id); ?>");
    <?php endif; ?>
 ...
 <script>
    ...
    function timerIncrement() {
        ...
        if (idleTime > 10) { // 10 minutes, you can adjust this to your need
            window.location.href = '<?php echo e(route('lock')); ?>';
        }
    }
...
<script>
 ...
 <?php echo $__env->yieldContent('script-bottom'); ?><?php /**PATH /home/user/htdocs/srv617279.hstgr.cloud/resources/views/layouts/vendor-scripts.blade.php ENDPATH**/ ?>