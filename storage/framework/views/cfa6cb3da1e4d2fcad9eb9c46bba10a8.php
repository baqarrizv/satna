        ...
        <div class="card h-100">
            <div class="card-body">
                <div class="text-center">
                    ...
                    <div>
                        <img src="<?php echo e($user->image ? asset($user->image) : asset('/assets/images/users/avatar-4.jpg')); ?>" alt="" class="avatar-lg rounded-circle img-thumbnail">
                    </div>
                    <h5 class="mt-3 mb-1"><?php echo e($user->name); ?></h5>
                    <p class="text-muted"><?php echo e($user->roles->pluck('name')->first()); ?></p>
                </div>
                ...
                <div class="text-muted display">
                    <div class="table-responsive mt-4">
                        <div>
                            <p class="mb-1">Name :</p>
                            <h5 class="font-size-16"><?php echo e($user->name); ?></h5>
                        </div>
                        <div class="mt-4">
                            <p class="mb-1">E- mail :</p>
                            <h5 class="font-size-16"><?php echo e($user->email); ?></h5>
                        </div>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" required class="form-control <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password_confirmation" name="password_confirmation" class="form-control <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                            ...
                            <a href="<?php echo e($notification->data['url'] ?? route('notifications.index')); ?>" class="text-dark notification-item">
                                <div class="d-flex align-items-start justify-content-between">
                                    ...
                                    <div class="ms-auto align-self-center">
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e(route('notifications.read', $notification->id)); ?>" class="btn btn-sm btn-primary">Mark as Read</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </a>                             
                    ...
                    <div>
                        ...
                        <div class="infinite-scroll">
                            <ul class="verti-timeline list-unstyled" id="activity-logs">
                                <?php echo $__env->make('activity_logs.partials.logs', ['activities' => $activities], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </ul>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/htdocs/srv617279.hstgr.cloud/resources/views/users/profile.blade.php ENDPATH**/ ?>