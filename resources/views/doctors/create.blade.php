                    ...
                    <form action="{{ route('doctors.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="dob" required class="form-control @error('dob') is-invalid @enderror" value="{{ old('dob') }}">
                                    @error('dob')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="contact_number" name="contact_number" required class="phone form-control @error('contact_number') is-invalid @enderror" value="{{ old('contact_number') }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="cnic" name="cnic" required class="form-control @error('cnic') is-invalid @enderror" value="{{ old('cnic') }}">
                                    @error('cnic')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="doctor_id" required class="form-control @error('doctor_id') is-invalid @enderror" value="{{ old('doctor_id') }}">
                                    @error('doctor_id')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="date_of_appointment" required class="form-control @error('date_of_appointment') is-invalid @enderror" value="{{ old('date_of_appointment') }}">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="specialist" required class="form-control @error('specialist') is-invalid @enderror" value="{{ old('specialist') }}">
                                    @error('specialist')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="emergency_contact_name" required class="form-control @error('emergency_contact_name') is-invalid @enderror" value="{{ old('emergency_contact_name') }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="emergency_contact_number" required class="phone form-control @error('emergency_contact_number') is-invalid @enderror" value="{{ old('emergency_contact_number') }}">
                        ...
                        <div class="row">    
                            ...
                            <div id="qualification_fields">
                                @foreach (old('degrees', ['']) as $key => $degree)
                                    <div class="qualification_entry row mb-3">
                                        <!-- For the first row (show labels) -->
                                        @if ($loop->first)
                                            <div class="col-md-4">
                                                <label for="degrees[]" class="form-label">Degree</label>
                                                <input type="text" name="degrees[]" required class="form-control @error('degrees.' . $key) is-invalid @enderror" value="{{ old('degrees.' . $key, $degree) }}">
                                                @error('degrees.' . $key)
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="majors[]" required class="form-control @error('majors.' . $key) is-invalid @enderror" value="{{ old('majors.' . $key) }}">
                                                @error('majors.' . $key)
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="institutions[]" required class="form-control @error('institutions.' . $key) is-invalid @enderror" value="{{ old('institutions.' . $key) }}">
                                                @error('institutions.' . $key)
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        @else
                                        <!-- For all other rows (hide labels) -->
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="degrees[]" required class="form-control" placeholder="Degree" value="{{ old('degrees.' . $key, $degree) }}">
                                                @error('degrees.' . $key)
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="majors[]" required class="form-control" placeholder="Majors" value="{{ old('majors.' . $key) }}">
                                                @error('majors.' . $key)
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="institutions[]" required class="form-control" placeholder="Institution" value="{{ old('institutions.' . $key) }}">
                                                @error('institutions.' . $key)
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div id="experience_fields">
                                @foreach (old('last_employers', ['']) as $key => $employer)
                                    <div class="experience_entry row mb-3">
                                        <!-- For the first row (show labels) -->
                                        @if ($loop->first)
                                            <div class="col-md-3">
                                                <label for="last_employers[]" class="form-label">Last Employer</label>
                                                <input type="text" name="last_employers[]" required class="form-control @error('last_employers.' . $key) is-invalid @enderror" value="{{ old('last_employers.' . $key, $employer) }}">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" name="designations[]" required class="form-control @error('designations.' . $key) is-invalid @enderror" value="{{ old('designations.' . $key) }}">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" name="start_dates[]" required class="form-control @error('start_dates.' . $key) is-invalid @enderror" value="{{ old('start_dates.' . $key) }}">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" name="end_dates[]" required class="form-control @error('end_dates.' . $key) is-invalid @enderror" value="{{ old('end_dates.' . $key) }}">
                                                @error('end_dates.' . $key)
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <!-- For all other rows (hide labels) -->
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" name="last_employers[]" required class="form-control" placeholder="Last Employer" value="{{ old('last_employers.' . $key, $employer) }}">
                                                @error('last_employers.' . $key)
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" name="designations[]" required class="form-control" placeholder="Designation" value="{{ old('designations.' . $key) }}">
                                                @error('designations.' . $key)
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <input type="date" name="start_dates[]" required class="form-control" placeholder="Start Date" value="{{ old('start_dates.' . $key) }}">
                                                @error('start_dates.' . $key)
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <input type="date" name="end_dates[]" required class="form-control" placeholder="End Date" value="{{ old('end_dates.' . $key) }}">
                                                @error('end_dates.' . $key)
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="doctor_portion" id="doctor_portion" step="1" required class="form-control @error('doctor_portion') is-invalid @enderror" value="{{ old('doctor_portion') }}">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="clinic_portion" id="clinic_portion" step="1" required class="form-control @error('clinic_portion') is-invalid @enderror" value="{{ old('clinic_portion') }}">
