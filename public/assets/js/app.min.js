!(function (e) {
    ...
    function a(e) {
        ...
        "dark" === e
            ? (document.body.setAttribute("data-bs-theme", "dark"),
              ...
              (!t.hasAttribute("data-layout") ||
                  "horizontal" != t.getAttribute("data-layout")) &&
                  document.body.setAttribute("data-sidebar", "dark"))
    ...
    !(function () {
        if (window.localStorage) {
            ...
            e ? a(e) : (localStorage.setItem("theme", "light"), a("light"));
        }
    })(),
        e("#side-menu").metisMenu(),
        (n = document.body.getAttribute("data-sidebar-size")),
        ...
        (function () {
            ...
            var t = e(this).attr("data-delay")
                    ? e(this).attr("data-delay")
                    : 100,
                a = e(this).attr("data-time")
                    ? e(this).attr("data-time")
                    : 1200;
            e('[data-plugin="counterup"]').each(function (n, d) {
                e(this).counterUp({ delay: t, time: a });
            });
        })(),
        e(window).on("load", function () {
        ...
        e("#mode-setting-btn").on("click", function (e) {
            d.hasAttribute("data-bs-theme") &&
            "dark" == d.getAttribute("data-bs-theme")
                ? (localStorage.setItem("theme", "light"), a("light"))
                : (localStorage.setItem("theme", "dark"), a("dark"));
        }),
        Waves.init();
})(jQuery);
